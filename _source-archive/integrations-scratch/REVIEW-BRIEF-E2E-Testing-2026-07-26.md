...
> `72.61.240.224`). Please review adversarially — §5 lists the claims I am least confident in and
...
2. **"The UTILITY re-cut will fix the quality throttle."** False. My own disproof test (send v4 to
   ...
   (`917972672473`), not copy-related. Meta also kept v4 *and* v5 as MARKETING despite UTILITY
   being requested.
...
link · Meta's recipient-level quality restriction on `917972672473` (Meta-side recovery, not a code fix).

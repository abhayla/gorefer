#!/usr/bin/env bash
# GoRefer production deploy — Hostinger VPS 72.61.240.224 (docs/deploy/DEPLOY-TARGET.md is
...
#
# Target + access per docs/deploy/DEPLOY-TARGET.md: root@72.61.240.224 over SSH with key
...
SSH_HOSTNAME="${DEPLOY_SSH_HOSTNAME:-72.61.240.224}"
